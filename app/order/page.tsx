...
const FlourishWaveFoods: React.FC = () => {
  ...
  const menuCategories: MenuCategory[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { name: "Hernö", price: 1500},
        { name: "Heineken", price: 1500},
      ]
    },
    {
  ...
  return (
    <div ref={containerRef} className="h-screen bg-linear-to-br from-gray-900 via-black to-gray-900 text-white overflow-y-auto scroll-smooth">
