...
export default function MoniepointPayment() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-linear-to-br from-[#f5d5c8] via-[#e8c4b8] to-[#d4b5a8]">
      ...
      <div className="bg-white/95 p-12 md:p-16 rounded-3xl shadow-2xl text-center max-w-md w-[90%] relative z-10">
        ...
        <div 
          onClick={copyAccount}
          className="text-5xl md:text-6xl font-black text-black my-8 tracking-wider leading-tight cursor-pointer p-6 md:p-8 bg-linear-to-br from-white to-gray-50 rounded-2xl transition-all duration-300 border-4 border-transparent hover:border-blue-600 hover:shadow-xl hover:scale-105 active:scale-95"
        >
          5187779100
        </div>
