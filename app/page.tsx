...
const FlourishWaveFoods: React.FC = () => {
  ...
  const menuCategories: MenuCategory[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { name: "Chapman", price: 3500 },
        { name: "Smirnoff Small", price: 2000 },
        { name: "Smirnoff Big", price: 2500 },
        ...
        { name: "Guilder", price: 1500},
        { name: "Goldberg", price: 1500},
        { name: "Medium Stout", price: 1500},
        { name: "Star", price: 1500},
        { name: "Star Radler", price: 1500},
        { name: "Disperado", price: 1200},
        { name: "Trophy", price: 1000},
        { name: "Trophy Staut", price: 1500},
        ...
        { name: "Power House", price: 2000},
        { name: "Black Bullet", price: 2000},
        { name: "Scudrum Small", price: 3500},
        { name: "Scudrum Big", price: 5000},
        { name: "Lacoco", price: 1000},
        { name: "Origin Bitter", price: 1000},
        { name: "Hirno", price: 1500},
        { name: "Henneken", price: 1500},
      ]
    },
    {
    ...
    },
    {
      ...
      items: [
        { name: "Edikankon", price: 2500 },
        { name: "Afam", price: 3000 },
        { name: "White Soup", price: 2500 },
        { name: "Okra / Draw Soup", price: 2500 },
        { name: "Fisherman Soup", price: 3500 },
      ]
    }
  ];
  ...
  return (
    <div ref={containerRef} className="h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 text-white overflow-y-auto scroll-smooth">
        ...
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <div className="relative">
              ...
              {searchQuery && (
                ...
                >
                 ...
                 className="absolute right-1 bg-red-500 -top-2 w-6 h-6 text-black rounded-full hover:text-white cursor-pointer" />
                </div>
              ) : (
                <div>
                  <Search
            ...
            <button
              ...
              className="relative bg-gradient-to-r from-orange-600 to-amber-600 p-3 rounded-full hover:from-orange-700 hover:to-amber-700 transition-all shadow-lg shadow-orange-500/50"
            >
          ...
          <div className="container mx-auto px-4 min-h-screen">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {filteredItems.map((item, idx) => (
                <div
                  key={idx}
                  className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 p-6 rounded-2xl border border-orange-500/20 hover:border-orange-500/50 transition-all hover:shadow-xl hover:shadow-orange-500/20"
                >
                  ...
                  <button
                    ...
                    className="w-full mt-4 bg-gradient-to-r from-orange-600 to-amber-600 py-2 rounded-lg font-semibold hover:from-orange-700 hover:to-amber-700 transition-all flex items-center justify-center gap-2"
                  >
              ...
              >
                <div className="container mx-auto px-4 w-full">
                  <div className="mb-8 text-center">
                    <h2 className="text-4xl md:text-5xl font-bold mb-4 bg-gradient-to-r from-orange-500 via-amber-500 to-orange-500 bg-clip-text text-transparent">
                      {category.title}
                    </h2>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
                    {category.items.map((item, idx) => (
                      <div
                        key={idx}
                        className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 p-6 rounded-2xl border border-orange-500/20 hover:border-orange-500/50 transition-all hover:shadow-xl hover:shadow-orange-500/20 hover:scale-105"
                      >
                        ...
                        <button
                          onClick={() => addToCart(item)}
                          className="w-full bg-gradient-to-r from-orange-600 to-amber-600 py-3 rounded-lg font-semibold hover:from-orange-700 hover:to-amber-700 transition-all flex items-center justify-center gap-2 shadow-lg"
                        >
              ...
              {!showCheckout ? (
                <>
                  ...
                  <button 
                    ...
                    className="w-full bg-gradient-to-r from-orange-600 to-amber-600 py-4 rounded-xl font-bold text-lg hover:from-orange-700 hover:to-amber-700 transition-all shadow-xl shadow-orange-500/50"
                  >
                    Proceed to Checkout
                  </button>
                </>
                ...
                <button 
                  ...
                  className="w-full bg-gradient-to-r from-green-600 to-emerald-600 py-4 rounded-xl font-bold text-lg hover:from-green-700 hover:to-emerald-700 transition-all shadow-xl shadow-green-500/50 flex items-center justify-center gap-2"
                >
